...
export async function coterieRoutes(fastify: FastifyInstance) {
  // Create coterie
  fastify.post<{ Body: typeof createCoterieSchema._type }>(
    "/coteries",
    {
      preHandler: authenticateUser,
      schema: {
        body: createCoterieSchema,
      },
    },
  ...
  // Get single coterie
  fastify.get<{ Params: typeof coterieParamsSchema._type }>(
    "/coteries/:id",
    {
      preHandler: authenticateUser,
      schema: {
        params: coterieParamsSchema,
      },
    },
    async (request: AuthenticatedRequest, reply) => {
      const userId = request.user!.id
  ...
  // Update coterie
  fastify.put<{
    Params: typeof coterieParamsSchema._type
    Body: typeof updateCoterieSchema._type
  }>(
    "/coteries/:id",
    {
      preHandler: authenticateUser,
  ...
  // Delete coterie
  fastify.delete<{ Params: typeof coterieParamsSchema._type }>(
    "/coteries/:id",
    {
      preHandler: authenticateUser,
      schema: {
  ...
  fastify.post<{
    Params: typeof coterieParamsSchema._type
    Body: typeof addCharacterToCoterieSchema._type
  }>(
    "/coteries/:id/characters",
    {
      ...
      schema: {
        params: coterieParamsSchema,
        body: addCharacterToCoterieSchema,
      },
    },
    async (request: AuthenticatedRequest, reply) => {
      const userId = request.user!.id
      const { id: coterieId } = request.params
  ...
  fastify.delete<{
    Params: typeof coterieParamsSchema._type & { characterId: string }
  }>(
    ...
    async (request: AuthenticatedRequest, reply) => {
      const userId = request.user!.id
      const { id: coterieId, characterId } = request.params as { id: string; characterId: string }

                        ...
                        <Stack gap="xl" align="center">
                            <Stack gap={10} align="center" mb={phoneScreen ? 4 : 8} w="100%">
                                ...
                                <div
                                    style={{
                                        width: 180,
                                        height: 2,
                                        background: `linear-gradient(90deg, transparent 0%, ${rgba(RAW_RED, 0.45)} 50%, transparent 100%)`
                                    }}
                                />
                                <Text
                                    ta="center"
                                ...
                                >
                                    A guided character creator for the night eternal. Craft your
                                    Kindred, then export them or carry them into play.
                                </Text>
                            </Stack>
                            ...
                            >
                                <Stack gap="sm">
                                    ...
                                    >
                                        When you&apos;re finished, download a printable PDF
                                        ...
                                        ) or save a JSON file you can re-load later to continue
                                        editing.
                                    </Text>
                                    <Text
                                        style={{
                                ...
                                <Button
                                    ...
                                    styles={{
                                        root: {
                                            ...
                                            textTransform: "uppercase",
                                            background: `linear-gradient(180deg, ${rgba(RAW_RED, 0.94)} 0%, rgba(168, 32, 32, 0.96) 100%)`,
                                            border: `1px solid ${rgba(RAW_RED, 0.55)}`,
                                            boxShadow: `0 10px 28px ${rgba(RAW_RED, 0.28)}, inset 0 1px 0 rgba(255, 255, 255, 0.08)`,
                                            transition:

...
const TouchstonePicker = ({ character, setCharacter, nextStep }: TouchstonePickerProps) => {
    ...
    return (
        <div>
            <Text mt={90} fw={700} fz={globals.isSmallScreen ? "xl" : "28px"} ta="center">Pick your Touchstones & Convictions</Text>
            <Text fz={globals.isSmallScreen ? "md" : "23px"} c={"grey"} ta="center">Touchstones are humans in your life that tie you to your humanity<br />Connect a conviction to each relationship</Text>

            <Text mt={"md"} ta="center" fz="xl" fw={700} c="red">Touchstones</Text>
            <hr color="#e03131" />
            <Space h={"sm"} />

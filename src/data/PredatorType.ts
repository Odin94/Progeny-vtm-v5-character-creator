...
export const PredatorTypes: Record<PredatorTypeName, PredatorType> = {
    ...
    Siren: {
        ...
        meritsAndFlaws: [{ name: "Beautiful", level: 2, summary: "" }, { name: "Enemy", level: 1, summary: "(spurned lover or jealous partner)" }],
        humanityChange: 0,
        bloodPotencyChange: 0,
    },
    Sandman: {
    ...
    Trapdoor: {
        ...
        meritsAndFlaws: [{ name: "Haven", level: 1, summary: "smell resonance in mortal blood" }, { name: "Choose one [Retainer, Herd, +1 Haven]", level: 1, summary: "" }, { name: "Choose one [Creepy, Haunted]", level: 1, summary: "" }],
        humanityChange: 0,
        bloodPotencyChange: 0,
    },
    Bagger: {
